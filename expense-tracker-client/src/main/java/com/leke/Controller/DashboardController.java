...
public class DashboardController {
    ...
    public void fetchUserData(){
        ...
        //so it refreshes and replace not add, we remove all children from dashboard view
        dashboardView.getRecentTransactionBox().getChildren().clear();
        dashboardView.getTransactionTable().getItems().clear();
    ...
    private void addMenuActions(){
        ...
        dashboardView.getViewCategoryMenuItem().setOnAction(new EventHandler<ActionEvent>() {
            @Override
            public void handle(ActionEvent actionEvent) {
