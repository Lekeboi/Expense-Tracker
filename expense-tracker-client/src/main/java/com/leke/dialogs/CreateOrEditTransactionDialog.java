...
public class CreateOrEditTransactionDialog extends CustomDialog{
    ...
    // uses for creating transactions
    ...
    private VBox createMainContentBox(){
        ...
        mainContentBox.getChildren().addAll(transactionNameField, transactionAmountField,
                transactionDatePicker, transactionCategoryBox, createTransactionTypeRadioButtonGroup(), createConfirmAndCancelButtonBox());
        ...
        saveButton.setOnMouseClicked(new EventHandler<MouseEvent>() {
            ...
            public void handle(MouseEvent mouseEvent) {
                ...
                if (!isEditing ? SqlUtil.postTransaction(transactionDataObject)
                    ...
                    Utilitie.showAlertDialog(Alert.AlertType.INFORMATION, isEditing ? "Successfully saved transaction!" : "Successfully created Transaction!");

                    //refresh our dashboard
                    dashboardController.fetchUserData();

                    //refresh transaction Components
                    if(isEditing){
                    ...
                    Utilitie.showAlertDialog(Alert.AlertType.ERROR, isEditing ? "Error: Failed to save transaction" :  "Error: Failed to Create Transaction...");
                }
            }
        });
