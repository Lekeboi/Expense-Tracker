...
public class TransactionCategoryController {
    ...
    @PostMapping
    public ResponseEntity<TransactionCategory> createTransacetionCategory(@RequestBody TransactionCategory transactionCategory){
    ...
    public ResponseEntity<TransactionCategory> updateTransactionCategoryById(@PathVariable int id, @RequestParam String newCategoryName, @RequestParam String newCategoryColor){
        logger.info("Updating TransactionCategory with Id: " + id);
